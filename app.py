...
data_path = r"C:\Users\ZBook\Desktop\juypter\projectFinal\zomato.csv"
...
def run_training(df_model, target_col, test_size, seed):
    ...
    X_train_pre = pre.fit_transform(X_train)  # ensure fitted
    ...
    if USE_KERAS:
        ...
        nn_acc = model.evaluate(X_test_pre, y_test, verbose=0)[1]
        nn_info["type"] = "Keras"
        nn_info["model"] = model
        nn_info["pre"] = pre
